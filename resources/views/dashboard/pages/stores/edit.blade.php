            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">تعديل مخزن</h2>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">تعديل مخزن</h4>
                                </div>
                                <div class="card-body">
                                    <form class="row" action="{{ route('stores.update',$store->id) }}" method="POST">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <input type="text" value="{{ old('name',$store->name) }}" name="name" class="form-control credit-card-mask" placeholder="اسم المخزن"  />
