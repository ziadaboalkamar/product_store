            ...
            <div class="content-body">
                <div class="content-wrapper">
                    <div class="content-header row">
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-left mb-0">المخازن</h2>
                    ...
                    <div class="content-body">
                        ...
                        <form action="{{route('stores.create')}}" method="get" class="d-none" id="create_new">
                            @csrf
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel"> حذف مخزن <span class="text-primary">{{ $store->name }}</span></h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form action="{{ route('stores.delete',$store->id) }}" method="post">
                                            {{ csrf_field() }}
                ...
                // Actions
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return (
                            ...
                            '<a href="stores/edit/'+ id +'" class="dropdown-item">' +
