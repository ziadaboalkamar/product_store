        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <section class="invoice-add-wrapper">
                    <form action="{{route('admin.invoice.sale.store')}}" method="post">
                        @csrf
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        ...
                                        <div class="invoice-number-date mt-md-0 mt-2">
                                            <div class="d-flex align-items-center mb-1">
                                                ...
                                                <input type="text" name="date" class="form-control invoice-edit-input date-picker" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                        </div>--}}
                                ...
                                <div class="card-body invoice-padding invoice-product-details">
                                                    ...
                                                    <div class="col-12 d-flex product-details-border position-relative pr-0">
                                                        <div class="row w-100 pr-lg-0 pr-1 py-2">
                                                            <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                ...
                                                                <select name="product_id" class="form-control item-details">

                                                                    @if ($products && $products->count() > 0)
                                                                        @foreach ($products as $product)
                                                                            <option value="{{ $product->id }}"
                                                                                {{ old('product_id') == $product->id ? 'selected' : null }}>
                                                                                {{ $product->name }}</option>
                                    ...
                                    <button class="btn btn-primary btn-block mt-5 mb-75" >Send Invoice</button>
